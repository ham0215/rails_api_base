...
class User < ApplicationRecord
  ...
  def self.{:locale=>{:en=>0, :ja=>1}}s; end
...
module User::GeneratedAssociationMethods
  ...
  sig { returns(::Portfolio::ActiveRecord_Associations_CollectionProxy) }
  def portfolios; end

  sig { returns(T::Array[Integer]) }
  def portfolio_ids; end

  sig { params(value: T::Enumerable[::Portfolio]).void }
  def portfolios=(value); end
  ...
  sig { returns(::Book::ActiveRecord_Associations_CollectionProxy) }
  def sorted_books; end

  sig { returns(T::Array[Integer]) }
  def sorted_book_ids; end

  sig { params(value: T::Enumerable[::Book]).void }
  def sorted_books=(value); end

  sig { returns(::Portfolio::ActiveRecord_Associations_CollectionProxy) }
  def sorted_portfolios; end

  sig { returns(T::Array[Integer]) }
  def sorted_portfolio_ids; end

  sig { params(value: T::Enumerable[::Portfolio]).void }
  def sorted_portfolios=(value); end
